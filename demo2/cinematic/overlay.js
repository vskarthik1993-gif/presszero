import { createScrubber } from "./scrub.js?v=28";
import { createReceptionMascot } from "./mascot.js?v=28";

const ASSET = (name) => new URL(`./assets/${name}?v=28`, import.meta.url).href;
