import { createScrubber } from "./scrub.js?v=27";
import { createReceptionMascot } from "./mascot.js?v=27";

const ASSET = (name) => new URL(`./assets/${name}?v=27`, import.meta.url).href;
