import { createScrubber } from "./scrub.js?v=30";
import { createReceptionMascot } from "./mascot.js?v=30";

const ASSET = (name) => new URL(`./assets/${name}?v=30`, import.meta.url).href;
