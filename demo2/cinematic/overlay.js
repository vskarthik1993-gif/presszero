import { createScrubber } from "./scrub.js?v=26";
import { createReceptionMascot } from "./mascot.js?v=26";

const ASSET = (name) => new URL(`./assets/${name}?v=26`, import.meta.url).href;
